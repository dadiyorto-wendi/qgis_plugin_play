...
SOURCES = \
	__init__.py \
	hydrological_analysis_tool.py hydrological_analysis_tool_dockwidget.py

PLUGINNAME = hydrological_analysis_tool

PY_FILES = \
	__init__.py \
	hydrological_analysis_tool.py hydrological_analysis_tool_dockwidget.py

UI_FILES = hydrological_analysis_tool_dockwidget_base.ui
